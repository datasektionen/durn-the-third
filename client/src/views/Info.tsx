    ...
    <Container my="md">
      <div className={cx(constants.themeColor, "lighten-4", classes.infoBox)}>
        ...
        <p>
          ...
          a few desirable properties, one of the major ones for our interests being that it produces an ranking of the candidates.
        ...
        <p>
          ...
          for allowing this would be to store which user made each vote in the database, which would allow anyone with
          ...
          However, we don't have access to any kind of information to create this hash that isn't either public or not permanent.
